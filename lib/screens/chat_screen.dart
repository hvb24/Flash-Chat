...
class _ChatScreenState extends State<ChatScreen> {
  ...
  // static User fromJson(Map<String,dynamic> json)=> message(
  //   sender:json['sender'],
  //   text:json['text'],
  // );
                  ...
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    return ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          // print(jsonDecode(messages[index].data()));
                          // print();
                          var message =
                          ...
                          return Dismissible(
                              ...
                              child: Card(
                                elevation: 4,
                                child: ListTile(
                                  title: Text(message["sender"] == null
                                      ? "Null"
                                      : message["sender"]),
                                  subtitle:
                                  Text(message["text"]==null ? "NULL":message["text"] ),
                                ),
                              ));
                          // return Column(
                          //   children: [
                          //     ListView(
                          //       children: [Text(message["sender"] == null
                          //               ? "Null"
                          //               : message["sender"]),
                          //       Text(message["text"]==null ? "NULL":message["text"]) ],
                          //     )
